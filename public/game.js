...
class Game3FishingGame {
  constructor(controller) {
    ...
    this.bradanRequested = false;     // Track if bradan has been requested yet (guarantee at least once)
...
// FISH ATTRIBUTES
  ...
  getFishList() {
    return {
      ...
      stroilleag: { id: 'stroilleag', svg: './svgs/game-3/game-3-fish/stròilleag.svg', zone: 'SHALLOW', direction: 'UP', basePoints: 2, speed: 8.0, size: 185, spawnWeight: 3, isMultiDirectional: true, isValid: true },
      creagag: { id: 'creagag', svg: './svgs/game-3/game-3-fish/creagag-R.svg', zone: 'SHALLOW', direction: 'EITHER', svgFaces: 'R', basePoints: 2, speed: 8.0, size: 120, spawnWeight: 3, isValid: true },
  ...
  generateNewOrder() {
    // GUARANTEE BRADAN: When first entering DEEP zone, always request bradan!
    if (this.currentDepth === 'DEEP' && !this.bradanRequested) {
      this.bradanRequested = true;
      this.currentOrder = {
        type: 'fish',
        target: 'bradan'
      };
      this.updateOrderDisplay();
      this.spawnOrderedFish('bradan');
